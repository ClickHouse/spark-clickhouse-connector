...
trait SparkClickHouseClusterMixin {
  ...
  override def sparkOptions: Map[String, String] = Map(
    ...
    "spark.sql.defaultCatalog" -> "clickhouse_s1r1",
    "spark.sql.catalog.clickhouse_s1r1" -> "xenon.clickhouse.ClickHouseCatalog",
    "spark.sql.catalog.clickhouse_s1r1.host" -> clickhouse_s1r1_host,
    "spark.sql.catalog.clickhouse_s1r1.grpc_port" -> clickhouse_s1r1_grpc_port.toString,
    ...
    "spark.sql.catalog.clickhouse_s1r2.host" -> clickhouse_s1r2_host,
    "spark.sql.catalog.clickhouse_s1r2.grpc_port" -> clickhouse_s1r2_grpc_port.toString,
    ...
    "spark.sql.catalog.clickhouse_s2r1.host" -> clickhouse_s2r1_host,
    "spark.sql.catalog.clickhouse_s2r1.grpc_port" -> clickhouse_s2r1_grpc_port.toString,
    ...
    "spark.sql.catalog.clickhouse_s2r2.host" -> clickhouse_s2r2_host,
    "spark.sql.catalog.clickhouse_s2r2.grpc_port" -> clickhouse_s2r2_grpc_port.toString,
