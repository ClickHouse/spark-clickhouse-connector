...
spark.clickhouse.write.settings|<undefined>|Settings when writing to ClickHouse as comma-separated `k=v` entries. Per-write options `clickhouse_setting_<name>=<value>` override these settings. Precedence: SQLConf < write option `spark.clickhouse.write.settings` < `clickhouse_setting_*`.|0.10.1
<!--end-include-->
