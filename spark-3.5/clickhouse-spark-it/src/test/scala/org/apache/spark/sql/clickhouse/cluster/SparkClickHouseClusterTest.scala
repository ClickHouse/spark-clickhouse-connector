...
trait SparkClickHouseClusterTest extends SparkTest with ClickHouseClusterMixIn {
  ...
  override protected def sparkConf: SparkConf = super.sparkConf
    ...
    .set("spark.sql.catalog.clickhouse_s1r1", "com.clickhouse.ClickHouseCatalog")
    ...
    .set("spark.sql.catalog.clickhouse_s1r2", "com.clickhouse.ClickHouseCatalog")
    ...
    .set("spark.sql.catalog.clickhouse_s2r1", "com.clickhouse.ClickHouseCatalog")
    ...
    .set("spark.sql.catalog.clickhouse_s2r2", "com.clickhouse.ClickHouseCatalog")
