...
// copy and replace `M\((\d+),\s(.*)\).*\\` with `$2($1, "$2"),`
public enum ClickHouseErrCode {
    ...
    RAFT_ERROR(568, "RAFT_ERROR"),
    MULTIPLE_COLUMNS_SERIALIZED_TO_SAME_PROTOBUF_FIELD(569, "MULTIPLE_COLUMNS_SERIALIZED_TO_SAME_PROTOBUF_FIELD"),
    DATA_TYPE_INCOMPATIBLE_WITH_PROTOBUF_FIELD(570, "DATA_TYPE_INCOMPATIBLE_WITH_PROTOBUF_FIELD"),
    DATABASE_REPLICATION_FAILED(571, "DATABASE_REPLICATION_FAILED"),
    TOO_MANY_QUERY_PLAN_OPTIMIZATIONS(572, "TOO_MANY_QUERY_PLAN_OPTIMIZATIONS"),
    EPOLL_ERROR(573, "EPOLL_ERROR"),
    DISTRIBUTED_TOO_MANY_PENDING_BYTES(574, "DISTRIBUTED_TOO_MANY_PENDING_BYTES"),
    UNKNOWN_SNAPSHOT(575, "UNKNOWN_SNAPSHOT"),
    KERBEROS_ERROR(576, "KERBEROS_ERROR"),
    INVALID_SHARD_ID(577, "INVALID_SHARD_ID"),
    INVALID_FORMAT_INSERT_QUERY_WITH_DATA(578, "INVALID_FORMAT_INSERT_QUERY_WITH_DATA"),
    INCORRECT_PART_TYPE(579, "INCORRECT_PART_TYPE"),
    CANNOT_SET_ROUNDING_MODE(580, "CANNOT_SET_ROUNDING_MODE"),
    TOO_LARGE_DISTRIBUTED_DEPTH(581, "TOO_LARGE_DISTRIBUTED_DEPTH"),
    NO_SUCH_PROJECTION_IN_TABLE(582, "NO_SUCH_PROJECTION_IN_TABLE"),
    ILLEGAL_PROJECTION(583, "ILLEGAL_PROJECTION"),
    PROJECTION_NOT_USED(584, "PROJECTION_NOT_USED"),
    CANNOT_PARSE_YAML(585, "CANNOT_PARSE_YAML"),
    CANNOT_CREATE_FILE(586, "CANNOT_CREATE_FILE"),
    CONCURRENT_ACCESS_NOT_SUPPORTED(587, "CONCURRENT_ACCESS_NOT_SUPPORTED"),
    DISTRIBUTED_BROKEN_BATCH_INFO(588, "DISTRIBUTED_BROKEN_BATCH_INFO"),
    DISTRIBUTED_BROKEN_BATCH_FILES(589, "DISTRIBUTED_BROKEN_BATCH_FILES"),
    CANNOT_SYSCONF(590, "CANNOT_SYSCONF"),
    SQLITE_ENGINE_ERROR(591, "SQLITE_ENGINE_ERROR"),
    DATA_ENCRYPTION_ERROR(592, "DATA_ENCRYPTION_ERROR"),
    ZERO_COPY_REPLICATION_ERROR(593, "ZERO_COPY_REPLICATION_ERROR"),
    BZIP2_STREAM_DECODER_FAILED(594, "BZIP2_STREAM_DECODER_FAILED"),
    BZIP2_STREAM_ENCODER_FAILED(595, "BZIP2_STREAM_ENCODER_FAILED"),
    INTERSECT_OR_EXCEPT_RESULT_STRUCTURES_MISMATCH(596, "INTERSECT_OR_EXCEPT_RESULT_STRUCTURES_MISMATCH"),
    NO_SUCH_ERROR_CODE(597, "NO_SUCH_ERROR_CODE"),
    BACKUP_ALREADY_EXISTS(598, "BACKUP_ALREADY_EXISTS"),
    BACKUP_NOT_FOUND(599, "BACKUP_NOT_FOUND"),
    BACKUP_VERSION_NOT_SUPPORTED(600, "BACKUP_VERSION_NOT_SUPPORTED"),
    BACKUP_DAMAGED(601, "BACKUP_DAMAGED"),
    NO_BASE_BACKUP(602, "NO_BASE_BACKUP"),
    WRONG_BASE_BACKUP(603, "WRONG_BASE_BACKUP"),
    BACKUP_ENTRY_ALREADY_EXISTS(604, "BACKUP_ENTRY_ALREADY_EXISTS"),
    BACKUP_ENTRY_NOT_FOUND(605, "BACKUP_ENTRY_NOT_FOUND"),
    BACKUP_IS_EMPTY(606, "BACKUP_IS_EMPTY"),
    BACKUP_ELEMENT_DUPLICATE(607, "BACKUP_ELEMENT_DUPLICATE"),
    CANNOT_RESTORE_TABLE(608, "CANNOT_RESTORE_TABLE"),
    FUNCTION_ALREADY_EXISTS(609, "FUNCTION_ALREADY_EXISTS"),
    CANNOT_DROP_SYSTEM_FUNCTION(610, "CANNOT_DROP_SYSTEM_FUNCTION"),
    CANNOT_CREATE_RECURSIVE_FUNCTION(611, "CANNOT_CREATE_RECURSIVE_FUNCTION"),
    OBJECT_ALREADY_STORED_ON_DISK(612, "OBJECT_ALREADY_STORED_ON_DISK"),
    OBJECT_WAS_NOT_STORED_ON_DISK(613, "OBJECT_WAS_NOT_STORED_ON_DISK"),
    POSTGRESQL_CONNECTION_FAILURE(614, "POSTGRESQL_CONNECTION_FAILURE"),
    CANNOT_ADVISE(615, "CANNOT_ADVISE"),
    UNKNOWN_READ_METHOD(616, "UNKNOWN_READ_METHOD"),
    LZ4_ENCODER_FAILED(617, "LZ4_ENCODER_FAILED"),
    LZ4_DECODER_FAILED(618, "LZ4_DECODER_FAILED"),
    POSTGRESQL_REPLICATION_INTERNAL_ERROR(619, "POSTGRESQL_REPLICATION_INTERNAL_ERROR"),
    QUERY_NOT_ALLOWED(620, "QUERY_NOT_ALLOWED"),
    CANNOT_NORMALIZE_STRING(621, "CANNOT_NORMALIZE_STRING"),
    CANNOT_PARSE_CAPN_PROTO_SCHEMA(622, "CANNOT_PARSE_CAPN_PROTO_SCHEMA"),
    CAPN_PROTO_BAD_CAST(623, "CAPN_PROTO_BAD_CAST"),
    BAD_FILE_TYPE(624, "BAD_FILE_TYPE"),
    IO_SETUP_ERROR(625, "IO_SETUP_ERROR"),
    CANNOT_SKIP_UNKNOWN_FIELD(626, "CANNOT_SKIP_UNKNOWN_FIELD"),
    BACKUP_ENGINE_NOT_FOUND(627, "BACKUP_ENGINE_NOT_FOUND"),
    OFFSET_FETCH_WITHOUT_ORDER_BY(628, "OFFSET_FETCH_WITHOUT_ORDER_BY"),
    HTTP_RANGE_NOT_SATISFIABLE(629, "HTTP_RANGE_NOT_SATISFIABLE"),
    HAVE_DEPENDENT_OBJECTS(630, "HAVE_DEPENDENT_OBJECTS"),
    UNKNOWN_FILE_SIZE(631, "UNKNOWN_FILE_SIZE"),
    UNEXPECTED_DATA_AFTER_PARSED_VALUE(632, "UNEXPECTED_DATA_AFTER_PARSED_VALUE"),
    QUERY_IS_NOT_SUPPORTED_IN_WINDOW_VIEW(633, "QUERY_IS_NOT_SUPPORTED_IN_WINDOW_VIEW"),
    MONGODB_ERROR(634, "MONGODB_ERROR"),
    CANNOT_POLL(635, "CANNOT_POLL"),
    CANNOT_EXTRACT_TABLE_STRUCTURE(636, "CANNOT_EXTRACT_TABLE_STRUCTURE"),
    INVALID_TABLE_OVERRIDE(637, "INVALID_TABLE_OVERRIDE"),
    SNAPPY_UNCOMPRESS_FAILED(638, "SNAPPY_UNCOMPRESS_FAILED"),
    SNAPPY_COMPRESS_FAILED(639, "SNAPPY_COMPRESS_FAILED"),
    NO_HIVEMETASTORE(640, "NO_HIVEMETASTORE"),
    CANNOT_APPEND_TO_FILE(641, "CANNOT_APPEND_TO_FILE"),
    CANNOT_PACK_ARCHIVE(642, "CANNOT_PACK_ARCHIVE"),
    CANNOT_UNPACK_ARCHIVE(643, "CANNOT_UNPACK_ARCHIVE"),
    REMOTE_FS_OBJECT_CACHE_ERROR(644, "REMOTE_FS_OBJECT_CACHE_ERROR"),
    NUMBER_OF_DIMENSIONS_MISMATHED(645, "NUMBER_OF_DIMENSIONS_MISMATHED"),
    CANNOT_BACKUP_DATABASE(646, "CANNOT_BACKUP_DATABASE"),
    CANNOT_BACKUP_TABLE(647, "CANNOT_BACKUP_TABLE"),
    WRONG_DDL_RENAMING_SETTINGS(648, "WRONG_DDL_RENAMING_SETTINGS"),
    INVALID_TRANSACTION(649, "INVALID_TRANSACTION"),
    SERIALIZATION_ERROR(650, "SERIALIZATION_ERROR"),
    CAPN_PROTO_BAD_TYPE(651, "CAPN_PROTO_BAD_TYPE"),
    ONLY_NULLS_WHILE_READING_SCHEMA(652, "ONLY_NULLS_WHILE_READING_SCHEMA"),
    CANNOT_PARSE_BACKUP_SETTINGS(653, "CANNOT_PARSE_BACKUP_SETTINGS"),
    WRONG_BACKUP_SETTINGS(654, "WRONG_BACKUP_SETTINGS"),
    FAILED_TO_SYNC_BACKUP_OR_RESTORE(655, "FAILED_TO_SYNC_BACKUP_OR_RESTORE"),
    UNKNOWN_STATUS_OF_TRANSACTION(659, "UNKNOWN_STATUS_OF_TRANSACTION"),
    HDFS_ERROR(660, "HDFS_ERROR"),
    CANNOT_SEND_SIGNAL(661, "CANNOT_SEND_SIGNAL"),
    FS_METADATA_ERROR(662, "FS_METADATA_ERROR"),
    INCONSISTENT_METADATA_FOR_BACKUP(663, "INCONSISTENT_METADATA_FOR_BACKUP"),
    ACCESS_STORAGE_DOESNT_ALLOW_BACKUP(664, "ACCESS_STORAGE_DOESNT_ALLOW_BACKUP"),
    CANNOT_CONNECT_NATS(665, "CANNOT_CONNECT_NATS"),
    NOT_INITIALIZED(667, "NOT_INITIALIZED"),
    INVALID_STATE(668, "INVALID_STATE"),
    NAMED_COLLECTION_DOESNT_EXIST(669, "NAMED_COLLECTION_DOESNT_EXIST"),
    NAMED_COLLECTION_ALREADY_EXISTS(670, "NAMED_COLLECTION_ALREADY_EXISTS"),
    NAMED_COLLECTION_IS_IMMUTABLE(671, "NAMED_COLLECTION_IS_IMMUTABLE"),
    INVALID_SCHEDULER_NODE(672, "INVALID_SCHEDULER_NODE"),
    RESOURCE_ACCESS_DENIED(673, "RESOURCE_ACCESS_DENIED"),
    RESOURCE_NOT_FOUND(674, "RESOURCE_NOT_FOUND"),
    CANNOT_PARSE_IPV4(675, "CANNOT_PARSE_IPV4"),
    CANNOT_PARSE_IPV6(676, "CANNOT_PARSE_IPV6"),
    THREAD_WAS_CANCELED(677, "THREAD_WAS_CANCELED"),
    IO_URING_INIT_FAILED(678, "IO_URING_INIT_FAILED"),
    IO_URING_SUBMIT_ERROR(679, "IO_URING_SUBMIT_ERROR"),
    MIXED_ACCESS_PARAMETER_TYPES(690, "MIXED_ACCESS_PARAMETER_TYPES"),
    UNKNOWN_ELEMENT_OF_ENUM(691, "UNKNOWN_ELEMENT_OF_ENUM"),
    TOO_MANY_MUTATIONS(692, "TOO_MANY_MUTATIONS"),
    AWS_ERROR(693, "AWS_ERROR"),
    ASYNC_LOAD_CYCLE(694, "ASYNC_LOAD_CYCLE"),
    ASYNC_LOAD_FAILED(695, "ASYNC_LOAD_FAILED"),
    ASYNC_LOAD_CANCELED(696, "ASYNC_LOAD_CANCELED"),
    CANNOT_RESTORE_TO_NONENCRYPTED_DISK(697, "CANNOT_RESTORE_TO_NONENCRYPTED_DISK"),
    INVALID_REDIS_STORAGE_TYPE(698, "INVALID_REDIS_STORAGE_TYPE"),
    INVALID_REDIS_TABLE_STRUCTURE(699, "INVALID_REDIS_TABLE_STRUCTURE"),
    USER_SESSION_LIMIT_EXCEEDED(700, "USER_SESSION_LIMIT_EXCEEDED"),
    CLUSTER_DOESNT_EXIST(701, "CLUSTER_DOESNT_EXIST"),
    CLIENT_INFO_DOES_NOT_MATCH(702, "CLIENT_INFO_DOES_NOT_MATCH"),
    INVALID_IDENTIFIER(703, "INVALID_IDENTIFIER"),
    QUERY_CACHE_USED_WITH_NONDETERMINISTIC_FUNCTIONS(704, "QUERY_CACHE_USED_WITH_NONDETERMINISTIC_FUNCTIONS"),
    TABLE_NOT_EMPTY(705, "TABLE_NOT_EMPTY"),
    LIBSSH_ERROR(706, "LIBSSH_ERROR"),
    GCP_ERROR(707, "GCP_ERROR"),
    ILLEGAL_STATISTIC(708, "ILLEGAL_STATISTIC"),
    CANNOT_GET_REPLICATED_DATABASE_SNAPSHOT(709, "CANNOT_GET_REPLICATED_DATABASE_SNAPSHOT"),
    FAULT_INJECTED(710, "FAULT_INJECTED"),
    FILECACHE_ACCESS_DENIED(711, "FILECACHE_ACCESS_DENIED"),
    TOO_MANY_MATERIALIZED_VIEWS(712, "TOO_MANY_MATERIALIZED_VIEWS"),
    BROKEN_PROJECTION(713, "BROKEN_PROJECTION"),
